...
|---|---|---|
| [LitDiscover](litdiscover/) | Paper **desk-rejected by IP&M** (2026-07-07) — redo planned; engine on PyPI but **out of date** (v2.0.0 has a known bug, fixed locally 2026-07-07, not yet republished). Discovery-phase closed-corpus/live-S2 code unified 2026-07-14, canonical cold-start result promoted with improved recall/precision | Information Processing & Management (redo) |
...
**LitDiscover wiki:** `wiki/litdiscover/` now has `research-roadmap.md` + `phase-discovery-roadmap.md` (new 2026-07-14, superseding `background.md`) and `decisions.md`/`open-questions.md`/`deep-dives.md` (live, updated in place). `phase-representation-roadmap.md` and `lineages/` (three parallel corpus-structuring methods, 2026-07-13) both moved to `wiki/synthesis/` the same day — see `synthesis/roadmap.md`. Flagged, still not decided: RLS is disabled on all 6 tables in the `litreview-v2` Supabase project (anon key has full read/write).
