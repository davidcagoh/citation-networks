...
| [litdiscover/phase-discovery-roadmap.md](litdiscover/phase-discovery-roadmap.md) | Split out from research-roadmap.md (2026-07-14). Discovery-phase deep dive: current implementation (§1 rewritten 2026-07-14 from an actual code read — closed-corpus/live-S2 unified onto one `GraphSource`-backed operator implementation, see session 39), 27-method prior-art survey, operator inventory, **Experiment 1 — Cranfield-style gold standard, operator ablation/ordering/budget-normalized Pareto curves, paired significance testing**, simulation-vs-production gap |
