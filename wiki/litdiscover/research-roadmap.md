...
**Moved to its own file: [`phase-discovery-roadmap.md`](phase-discovery-roadmap.md)** (2026-07-14)
...
- Discovery-specific open decisions (which new method to scope first, precision-per-method
  design) live in `phase-discovery-roadmap.md` §7.
