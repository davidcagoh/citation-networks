...
| `FWD (unfiltered) + [citation-count frontier]` · `COMPOSE=chained` | Tried once, 2026-07-14 | **Rejected** | Both recall and precision got worse — noisy corpus, generic hub papers from the unfiltered forward step. Not retried. |
