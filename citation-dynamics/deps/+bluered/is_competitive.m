function [is_competitive] = is_competitive(cid_f, ha_f, hr_f, cid, ha, hr)
% is_competitive Adds a new configuration to the bisection front
%
%	  [is_competitive] = is_competitive(cid_f, ha_f, hr_f, cid, ha, hr)
%   returns a boolean value indicating whether the new configuration is competitive.
%
