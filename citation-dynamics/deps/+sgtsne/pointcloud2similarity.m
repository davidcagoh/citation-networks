function P = pointcloud2similarity(X, labels, no_dims, initial_dims, perplexity)
  ...
  P = sgtsne.d2p_perplexity(D, perplexity, 1e-5); % compute affinities using fixed perplexity
  clear D
